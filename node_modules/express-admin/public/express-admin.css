...
@media (max-width: 768px) {
	/*all field labels*/
	.ex-table .control-label { padding-bottom: 5px; }
	/*listview buttons*/
...
/*listview mtm labels*/
.ex-table tbody td .label { margin-right: 5px; }
.ex-table tbody td .label:last-child { margin: 0; }
...
.ex-table .label-default { color: #f8f8f2; }
/*checkbox remove inline*/
.ex-table .head td { padding-top: 0; padding-bottom: 0; }
.ex-table .head label { float: right; margin-bottom: 0; }
.ex-table .head label input { margin-top: 0; }
.ex-table .jumbotron { padding-left: 0; padding-right: 0; border-radius: 0; }
.ex-table .jumbotron label { font-size: 14px; font-weight: normal; cursor: pointer; margin-right: 8px; }
.ex-table .jumbotron label [type=checkbox] { position: relative; top: 3px; cursor: pointer; }
.ex-table .remove { margin-right: 2px; }
/*field error message*/
.ex-table .form-group .help-block { margin-bottom: 0; }
/*add another link*/
.ex-table tfoot > tr > td { text-align: right; padding-top: 0; padding-bottom: 0; }
